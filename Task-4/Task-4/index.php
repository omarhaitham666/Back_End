...
<header>
    <div class="container text-light d-flex justify-content-center  align-items-center margin-con">
        <h1 class="text-center align-items-center">Welcome To Our Store</h1>   
    </div>
